#!/usr/bin/env python3
"""Build, verify, and prepare MiniQdrant Journey workspaces."""
...
def check_chain(
    ...
    *,
    ...
    with tempfile.TemporaryDirectory(prefix="miniqdrant-journey-chain-") as raw:
        workspace = Path(raw)
...
def assert_stage_parity(
    ...
    *,
    ...
    with tempfile.TemporaryDirectory(
        prefix=f"miniqdrant-stage-{stage_number:02d}-"
    ) as raw:
        expected = Path(raw)
...
def main() -> int:
    ...
    default = ROOT.parent / "MiniQdrant-journey-workspace"
