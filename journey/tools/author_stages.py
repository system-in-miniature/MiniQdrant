#!/usr/bin/env python3
"""Materialize the reviewed bilingual MiniQdrant Stage lessons and layouts."""
...
[第 {chapter} 章](https://github.com/system-in-miniature/mini-qdrant/blob/main/docs/zh/tutorial/{CHAPTER_SLUGS[chapter]}.md)"""
    return f"""### Goal
...
[Chapter {chapter}](https://github.com/system-in-miniature/mini-qdrant/blob/main/docs/tutorial/{CHAPTER_SLUGS[chapter]}.md)"""
...
def main() -> int:
    ...
    if len(manifest.stages) != len(FACTS):
        raise ValueError("lesson facts must match the fifteen-Stage manifest")
    ...
    print("wrote 15 bilingual MiniQdrant goals and layouts")
    return 0
