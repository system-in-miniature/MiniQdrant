...
REPO_URL = "https://github.com/system-in-miniature/mini-qdrant"
META = re.compile(
...
def role_rank(path: str) -> int:
    if path.startswith(("src/miniqdrant/index/", "src/miniqdrant/storage/")):
        return 0
    if path.startswith("src/miniqdrant/"):
        return 1
...
def render_index(cards: list[Card], *, chinese: bool) -> str:
    if chinese:
        ...
        lines = [
            ...
            "",
            "This is the browser-based path among MiniQdrant's three learning modes. Use the [Mechanism Tutorial](../index.md) for topic-oriented study, or the [Agent-Guided usage guide](../agent-guide.md) for interactive CLI teaching.",
            "",
            "For an editor-focused diff, run `python -m journey.tools.build_journey study N` and open `../MiniQdrant-journey-workspace`.",
            "",
    ...
    for card in cards:
        ...
        chapter_link = (
            ...
            + {
                ...
                2: "02-points-payload.md",
                3: "03-wal-manifest.md",
                4: "04-segments.md",
                5: "05-hnsw.md",
                6: "06-filtering.md",
                7: "07-planner.md",
                8: "08-quantization.md",
                9: "09-optimizer.md",
                10: "10-snapshots-methodology.md",
            }[card.chapter]
        )
        lines.append(
